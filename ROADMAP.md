...
🟡 Fase 3.7 — Multi-tenant (EM ANDAMENTO — 3.7.2: 7 routers isolados e validados em staging: `technicians`, `clients`, `workOrders`, `budgets`, `checklists`, `technicianPortal`, `documents`)
...
| 3.7.2 | Isolamento de queries (helper `forTenant`) — **mais crítica** | 🟡 EM ANDAMENTO (7 routers isolados: `technicians`, `clients`, `workOrders`, `budgets`, `checklists`, `technicianPortal`, `documents`; próximo: `waterTankAdmin`/revisar restantes) |
