 ...
 * VARIANTE DE PRODUÇÃO — uso exclusivo no cutover (ver docs/RUNBOOK_CUTOVER_PRODUCAO.md, Fase 4).
 *
 * Não altera nada. Roda as queries 0.1/0.2/0.3 do PLANO_3.7.1f.md e,
 * para cada tabela com coluna tenantId, conta linhas totais e NULLs — desta vez
 * contra o banco de produção (que não passou pelas sub-fases incrementais).
 *
 * Uso: pnpm tsx scripts/diagnostico-3.7.1f-fase0-producao.ts
 */
